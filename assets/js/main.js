...
(function() {
  ...
  function openTicketModal(type) {
    ...
    document.getElementById('ticketTypeDisplay').value = type;
...
document.getElementById("ticketForm").addEventListener("submit", function (e) {
  ...
  // Fill payment info
  document.getElementById("ticketAmount").innerText = ticketPrices[ticketType];
  document.getElementById("accountNumber").innerText = phoneInput;

  // Switch views
  document.getElementById("ticketForm").classList.add("d-none");
  document.getElementById("paybillSection").classList.remove("d-none");
  document.querySelector(".modal-title").innerText = "Complete Payment";
...
document.getElementById("ticketModal").addEventListener("hidden.bs.modal", () => {
  ...
  document.getElementById("paybillSection").classList.add("d-none");

});
document.getElementById("paidBtn").addEventListener("click", () => {
  document.querySelector(".modal-title").innerText = "Processing Payment";

  // Hide paybill section
  document.getElementById("paybillSection").classList.add("d-none");
